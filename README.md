...
A classic Space Invaders game built using Python and Pygame. Players control a spaceship and must shoot down waves of invading aliens before they reach the bottom of the screen. The game features smooth movement, enemy AI, and increasing difficulty.

## 🎮 Features
- **Player Controls:** Move left and right, shoot projectiles.
- **Enemy Waves:** Aliens move in a formation and descend over time.
- **Collision Detection:** Destroy enemies with accurate hit detection.
- **Scoring System:** Earn points for each alien destroyed.
- **Increasing Difficulty:** Enemies speed up as the game progresses.

## 🖥️ How to Play
1. Use the **arrow keys** or **A/D** to move your spaceship.
